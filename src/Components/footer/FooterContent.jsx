    ...
    <>
     ...
     <div className='container' style={color}>
      <div className='row p-5 mk'>
       <div className='col-lg-3 text-white col-md-6 col-sm-6 '>
      ...
      <ul className='d-flex justify-content-center pt-2 gap-2 text-light list-unstyled'>
        <li>Australia</li>
        <li>Brazil</li>
        <li>Canada</li>
        <li>China</li>
      ...
      <div className='row text-white'>
        <div className='col-lg-3 col-md-6 col-sm-6'>
          <ul className='list-unstyled'>
            <li style={{fontWeight:'700'}}>AbeBooks</li>
            <li>Books, art</li>
            <li>& collectibles</li>
            <br/>
            <li style={{fontWeight:'700'}}>Shopbop</li>
            <li>Designer</li>
        ...
        <div className='col-lg-3 col-md-6 col-sm-6'>
          <ul className='list-unstyled'>
            <li style={{fontWeight:'700'}}>Amazon Web Services</li>
            <li>Scalable Cloud</li>
            <li>Computing Services</li>
            <br/>
            <li style={{fontWeight:'700'}}>Amazon Business</li>
        ...
        <div className='col-lg-3 col-md-6 col-sm-6'>
          <ul className='list-unstyled'>
            <li style={{fontWeight:'700'}}>Audible</li>
            <li>Download</li>
            <li>Audio Books</li>
            <br/>
            <li style={{fontWeight:'700'}}>Prime Now</li>
        ...
        <div className='col-lg-3 col-md-6 col-sm-6'>
          <ul className='list-unstyled'>
            <li style={{fontWeight:'700'}}>IMDb</li>
            <li>Movies, TV </li>
            <li>& Celebrities</li>
            <br/>
            <li style={{fontWeight:'700'}}>Amazon Prime Music</li>
